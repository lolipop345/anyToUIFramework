--!strict
local findOr = require(script.Parent:FindFirstChild('findOr'))
local slice = require(script.Parent:FindFirstChild('slice'))
...
local MAX_SAFE_INTEGER = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('number')).MAX_SAFE_INTEGER
