...
local Shared = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
...
exports.getInstanceFromNode = function(node): Fiber?
	...
	if ReactWorkTags == nil then
		local ReactReconciler = require(script.Parent.Parent:FindFirstChild('ReactReconciler.roblox')):: any
