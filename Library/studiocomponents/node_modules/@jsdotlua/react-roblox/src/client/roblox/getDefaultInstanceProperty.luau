...
local Symbol = require(script.Parent.Parent.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Symbol
