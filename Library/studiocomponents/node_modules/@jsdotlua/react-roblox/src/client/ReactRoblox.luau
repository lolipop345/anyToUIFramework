...
local ReactTypes = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
type ReactNodeList = ReactTypes.ReactNodeList
local ReactRobloxHostTypes = require(script.Parent:FindFirstChild('ReactRobloxHostTypes.roblox'))
...
ReactRobloxRoot = require(script.Parent:FindFirstChild('ReactRobloxRoot'))
...
local ReactReconciler = require(script.Parent.Parent:FindFirstChild('ReactReconciler.roblox'))-- local batchedEventUpdates = ReactReconciler.batchedEventUpdates
...
local ReactVersion = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactVersion
local invariant = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).invariant
local ReactFeatureFlags = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags
...
local ReactRobloxComponentTree = require(script.Parent:FindFirstChild('ReactRobloxComponentTree'))
...
local Event = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Event
local Change = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Change
local Tag = require(script.Parent.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Tag
