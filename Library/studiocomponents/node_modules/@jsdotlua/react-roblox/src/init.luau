...
local HostTypes = require(script:FindFirstChild('client'):FindFirstChild('ReactRobloxHostTypes.roblox'))
export type RootType = HostTypes.RootType
return require(script:FindFirstChild('client'):FindFirstChild('ReactRoblox'))