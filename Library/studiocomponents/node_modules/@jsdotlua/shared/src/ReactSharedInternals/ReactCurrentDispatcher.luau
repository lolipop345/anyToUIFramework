...
local ReactElementType = require(script.Parent.Parent:FindFirstChild('ReactElementType'))
type Source = ReactElementType.Source
local ReactTypes = require(script.Parent.Parent:FindFirstChild('ReactTypes'))
