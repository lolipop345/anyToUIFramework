...
local console = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('luau-polyfill')).console
...
local ReactCurrentDispatcher = require(script:FindFirstChild('ReactCurrentDispatcher'))
export type Dispatcher = ReactCurrentDispatcher.Dispatcher
local ReactCurrentBatchConfig = require(script:FindFirstChild('ReactCurrentBatchConfig'))
local ReactCurrentOwner = require(script:FindFirstChild('ReactCurrentOwner'))
local ReactDebugCurrentFrame = require(script:FindFirstChild('ReactDebugCurrentFrame'))
local IsSomeRendererActing = require(script:FindFirstChild('IsSomeRendererActing'))
