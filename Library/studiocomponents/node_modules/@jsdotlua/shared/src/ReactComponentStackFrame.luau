...
local ReactElementType = require(script.Parent:FindFirstChild('ReactElementType'))
type Source = ReactElementType.Source

-- ROBLOX deviation: Needed to properly type class components
local flowtypes = require(script.Parent:FindFirstChild('flowtypes.roblox'))
...
local ReactSymbols = require(script.Parent:FindFirstChild('ReactSymbols'))
...
local ConsolePatchingDev = require(script.Parent:FindFirstChild('ConsolePatchingDev.roblox'))
