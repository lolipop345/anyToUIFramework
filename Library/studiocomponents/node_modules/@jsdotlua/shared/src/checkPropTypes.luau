...
local console = require(script.Parent:FindFirstChild('console'))

local loggedTypeFailures = {}

local ReactComponentStackFrame = require(script.Parent:FindFirstChild('ReactComponentStackFrame'))
local describeUnknownElementTypeFrameInDEV =
	ReactComponentStackFrame.describeUnknownElementTypeFrameInDEV

local ReactSharedInternals = require(script.Parent:FindFirstChild('ReactSharedInternals'))

local describeError = require(script.Parent:FindFirstChild('ErrorHandling.roblox')).describeError
