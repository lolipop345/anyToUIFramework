...
local LuauPolyfill = require(script.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('luau-polyfill'))
type Object = LuauPolyfill.Object

local ReactTypes = require(script:FindFirstChild('ReactTypes'))
local flowtypes = require(script:FindFirstChild('flowtypes.roblox'))
local ReactElementType = require(script:FindFirstChild('ReactElementType'))
local ReactFiberHostConfig = require(script:FindFirstChild('ReactFiberHostConfig'))
local ReactSharedInternals = require(script:FindFirstChild('ReactSharedInternals'))
local ErrorHandling = require(script:FindFirstChild('ErrorHandling.roblox'))
...
return {
	checkPropTypes = require(script:FindFirstChild('checkPropTypes')),
	console = require(script:FindFirstChild('console')),
	ConsolePatchingDev = require(script:FindFirstChild('ConsolePatchingDev.roblox')),
	consoleWithStackDev = require(script:FindFirstChild('consoleWithStackDev')),
	enqueueTask = require(script:FindFirstChild('enqueueTask.roblox')),
	ExecutionEnvironment = require(script:FindFirstChild('ExecutionEnvironment')),
	formatProdErrorMessage = require(script:FindFirstChild('formatProdErrorMessage')),
	getComponentName = require(script:FindFirstChild('getComponentName')),
	invariant = require(script:FindFirstChild('invariant')),
	invokeGuardedCallbackImpl = require(script:FindFirstChild('invokeGuardedCallbackImpl')),
	isValidElementType = require(script:FindFirstChild('isValidElementType')),
	objectIs = require(script:FindFirstChild('objectIs')),
	ReactComponentStackFrame = require(script:FindFirstChild('ReactComponentStackFrame')),
	ReactElementType = require(script:FindFirstChild('ReactElementType')),
	ReactErrorUtils = require(script:FindFirstChild('ReactErrorUtils')),
	ReactFeatureFlags = require(script:FindFirstChild('ReactFeatureFlags')),
	ReactInstanceMap = require(script:FindFirstChild('ReactInstanceMap')),
	...
	ReactSymbols = require(script:FindFirstChild('ReactSymbols')),
	ReactVersion = require(script:FindFirstChild('ReactVersion')),
	shallowEqual = require(script:FindFirstChild('shallowEqual')),
	UninitializedState = require(script:FindFirstChild('UninitializedState.roblox')),
	...
	Symbol = require(script:FindFirstChild('Symbol.roblox')),
	Type = require(script:FindFirstChild('Type.roblox')),

	-- ROBLOX DEVIATION: export propmarkers from Shared
	Change = require(script:FindFirstChild('PropMarkers'):FindFirstChild('Change')),
	Event = require(script:FindFirstChild('PropMarkers'):FindFirstChild('Event')),
	Tag = require(script:FindFirstChild('PropMarkers'):FindFirstChild('Tag')),
}
