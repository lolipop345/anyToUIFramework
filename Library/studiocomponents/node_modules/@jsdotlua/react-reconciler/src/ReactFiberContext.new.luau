...
local isFiberMounted = require(script.Parent:FindFirstChild('ReactFiberTreeReflection')).isFiberMounted
local disableLegacyContext =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags.disableLegacyContext
