...
local flowtypes = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
...
local ReactRootTags = require(script.Parent:FindFirstChild('ReactRootTags'))
...
local ReactWorkTags = require(script.Parent:FindFirstChild('ReactWorkTags'))
...
local ReactFiberTreeReflection = require(script.Parent:FindFirstChild('ReactFiberTreeReflection'))
...
local getInstance = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactInstanceMap.get
...
local enableSchedulingProfiler =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags.enableSchedulingProfiler
...
local getPublicInstance = require(script.Parent:FindFirstChild('ReactFiberHostConfig')).getPublicInstance
...
local ReactFiberRoot = require(script.Parent:FindFirstChild('ReactFiberRoot.new'))
local createFiberRoot = ReactFiberRoot.createFiberRoot
local ReactFiberDevToolsHook = require(script.Parent:FindFirstChild('ReactFiberDevToolsHook.new'))
...
local markRenderScheduled = require(script.Parent:FindFirstChild('SchedulingProfiler')).markRenderScheduled
...
exports.createPortal = require(script.Parent:FindFirstChild('ReactPortal')).createPortal
