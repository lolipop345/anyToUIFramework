...
local Shared = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
...
local React = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('react'))
...
local ReactFiberSuspenseContext = require(script.Parent:FindFirstChild('ReactFiberSuspenseContext.new'))
type SuspenseContext = ReactFiberSuspenseContext.SuspenseContext

local ReactFiberOffscreenComponent = require(script.Parent:FindFirstChild('ReactFiberOffscreenComponent'))
...
local checkPropTypes = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).checkPropTypes

local ReactWorkTags = require(script.Parent:FindFirstChild('ReactWorkTags'))-- local IndeterminateComponent = ReactWorkTags.IndeterminateComponent
...
local ReactSharedInternals = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactSharedInternals
...
local invariant = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).invariant
...
local shallowEqual = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).shallowEqual
...
local ReactSymbols = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactSymbols
...
local ReactCurrentFiber = require(script.Parent:FindFirstChild('ReactCurrentFiber'))
...
local ReactFiberHotReloadingModule = require(script.Parent:FindFirstChild('ReactFiberHotReloading.new'))
...
local ReactChildFiber = require(script.Parent:FindFirstChild('ReactChildFiber.new')):: any
...
local ReactUpdateQueue = require(script.Parent:FindFirstChild('ReactUpdateQueue.new'))
...
local ReactTypeOfMode = require(script.Parent:FindFirstChild('ReactTypeOfMode'))
...
local ReactFiberHostConfig = require(script.Parent:FindFirstChild('ReactFiberHostConfig'))
...
local ReactFiberHostContext = require(script.Parent:FindFirstChild('ReactFiberHostContext.new'))
...
-- local {
--   ,
local ReactFiberNewContext = require(script.Parent:FindFirstChild('ReactFiberNewContext.new'))
...
local function shouldSuspend(fiber: Fiber): boolean
	if not lazyRefs.shouldSuspendRef then
		lazyRefs.shouldSuspendRef = require(script.Parent:FindFirstChild('ReactFiberReconciler')).shouldSuspend
	end
...
local function initReactFiberHooks()
	local ReactFiberHooks = require(script.Parent:FindFirstChild('ReactFiberHooks.new'))	
...
local stopProfilerTimerIfRunning =
	require(script.Parent:FindFirstChild('ReactProfilerTimer.new')).stopProfilerTimerIfRunning
local ReactFiberContext = require(script.Parent:FindFirstChild('ReactFiberContext.new'))
...
local ReactFiberHydrationContext = require(script.Parent:FindFirstChild('ReactFiberHydrationContext.new'))
...
local ReactFiberClassComponent = require(script.Parent:FindFirstChild('ReactFiberClassComponent.new')):: any
...
local resolveDefaultProps =
	require(script.Parent:FindFirstChild('ReactFiberLazyComponent.new')).resolveDefaultProps
local ReactFiber = require(script.Parent:FindFirstChild('ReactFiber.new'))
...
local ReactFiberWorkLoop = require(script.Parent:FindFirstChild('ReactFiberWorkLoop.new')):: any
...
local setWorkInProgressVersion =
	require(script.Parent:FindFirstChild('ReactMutableSource.new')).setWorkInProgressVersion
local markSkippedUpdateLanes =
	require(script.Parent:FindFirstChild('ReactFiberWorkInProgress')).markSkippedUpdateLanes
local ConsolePatchingDev = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ConsolePatchingDev
		...
		if enableSchedulerTracing then
			if Schedule_tracing_wrap == nil then
				Schedule_tracing_wrap =
					require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('scheduler')).tracing.unstable_wrap
			end
