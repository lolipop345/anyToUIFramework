...
local ReactUpdateQueueModule = require(script.Parent:FindFirstChild('ReactUpdateQueue.new'))
...
local ReactHookEffectTags = require(script.Parent:FindFirstChild('ReactHookEffectTags'))
...
local Schedule_tracing_wrap = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('scheduler')).tracing.unstable_wrap
...
local ReactCurrentFiber = require(script.Parent:FindFirstChild('ReactCurrentFiber'))--  ROBLOX deviation: this property would be captured as values instead of bound
...
local onCommitUnmount = require(script.Parent:FindFirstChild('ReactFiberDevToolsHook.new')).onCommitUnmount
...
local ProfileMode = require(script.Parent:FindFirstChild('ReactTypeOfMode')).ProfileMode
...
local function resolveRetryWakeable(boundaryFiber: Fiber, wakeable: Wakeable): ()
	if not ReactFiberWorkLoop then
		ReactFiberWorkLoop = require(script.Parent:FindFirstChild('ReactFiberWorkLoop.new')):: any
	end
...
local didWarnAboutReassigningProps = function()
	if not didWarnAboutReassigningPropsRef then
		didWarnAboutReassigningPropsRef =
			require(script.Parent:FindFirstChild('ReactFiberBeginWork.new')).didWarnAboutReassigningProps
	end
