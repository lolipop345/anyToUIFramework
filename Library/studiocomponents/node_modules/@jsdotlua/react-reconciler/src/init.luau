...
--!strict
local ReactInternalTypes = require(script:FindFirstChild('ReactInternalTypes'))
local ReactRootTags = require(script:FindFirstChild('ReactRootTags'))
...
for name, implementation in config do
	...
	return require(script:FindFirstChild('ReactFiberReconciler'))
end
