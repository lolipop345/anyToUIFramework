...
local ReactElementType = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))-- ROBLOX deviation: ReactElement is defined at the top level of Shared along
