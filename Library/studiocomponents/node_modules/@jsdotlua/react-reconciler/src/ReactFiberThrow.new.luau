...
local ReactCapturedValue = require(script.Parent:FindFirstChild('ReactCapturedValue'))
...
local shouldCaptureSuspense =
	require(script.Parent:FindFirstChild('ReactFiberSuspenseComponent.new')).shouldCaptureSuspense
...
local markLegacyErrorBoundaryAsFailed = function(...)
	if not markLegacyErrorBoundaryAsFailedRef then
		ReactFiberWorkLoop = require(script.Parent:FindFirstChild('ReactFiberWorkLoop.new'))		
...
local logCapturedError = require(script.Parent:FindFirstChild('ReactFiberErrorLogger')).logCapturedError
local logComponentSuspended = require(script.Parent:FindFirstChild('DebugTracing')).logComponentSuspended
local markComponentSuspended = require(script.Parent:FindFirstChild('SchedulingProfiler')).markComponentSuspended
