...
local enableFundamentalAPI =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags.enableFundamentalAPI
