...
local showErrorDialog = require(script.Parent:FindFirstChild('ReactFiberErrorDialog')).showErrorDialog
local ClassComponent = require(script.Parent:FindFirstChild('ReactWorkTags')).ClassComponent
