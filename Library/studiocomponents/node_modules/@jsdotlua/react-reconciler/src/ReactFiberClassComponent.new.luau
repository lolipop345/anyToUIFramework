...
local isMounted = require(script.Parent:FindFirstChild('ReactFiberTreeReflection')).isMounted
local ReactInstanceMap = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactInstanceMap
...
local UninitializedState = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).UninitializedState
...
local DebugTracing = require(script.Parent:FindFirstChild('DebugTracing'))
...
local function initializeClassComponentUpdater()
	local ReactFiberWorkLoop = require(script.Parent:FindFirstChild('ReactFiberWorkLoop.new'))	
local requestEventTime = ReactFiberWorkLoop.requestEventTime
	local requestUpdateLane = ReactFiberWorkLoop.requestUpdateLane
	local scheduleUpdateOnFiber = ReactFiberWorkLoop.scheduleUpdateOnFiber
