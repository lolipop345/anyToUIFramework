...
local ReactFiber = require(script.Parent:FindFirstChild('ReactFiber.new'))-- local createFiberFromHostInstanceForDeletion = ReactFiber.createFiberFromHostInstanceForDeletion
...
local enableSuspenseServerRenderer =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags.enableSuspenseServerRenderer
local OffscreenLane = require(script.Parent:FindFirstChild('ReactFiberLane')).OffscreenLane
