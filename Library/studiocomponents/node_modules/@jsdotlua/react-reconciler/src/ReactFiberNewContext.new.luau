...
local MAX_SIGNED_31_BIT_INT = require(script.Parent:FindFirstChild('MaxInts')).MAX_SIGNED_31_BIT_INT
...
local is = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).objectIs
