...
local ReactFiberLaneModule = require(script.Parent:FindFirstChild('ReactFiberLane'))
...
local enableDebugTracing =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags.enableDebugTracing
