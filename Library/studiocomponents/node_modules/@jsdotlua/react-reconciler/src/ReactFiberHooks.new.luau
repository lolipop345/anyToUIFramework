...
local createRef = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('react')).createRef
local createBinding = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('react')).createBinding
...
local DebugTracingMode = require(script.Parent:FindFirstChild('ReactTypeOfMode')).DebugTracingMode
...
local markWorkInProgressReceivedUpdate =
	require(script.Parent:FindFirstChild('ReactFiberBeginWork.new')).markWorkInProgressReceivedUpdate :: any
-- local {
...
local getIsHydrating = require(script.Parent:FindFirstChild('ReactFiberHydrationContext.new')).getIsHydrating
-- local {
--   makeClientId,
--   makeClientIdInDEV,
...
local ReactMutableSource = require(script.Parent:FindFirstChild('ReactMutableSource.new'))
...
local logStateUpdateScheduled = require(script.Parent:FindFirstChild('DebugTracing')).logStateUpdateScheduled
local markStateUpdateScheduled = require(script.Parent:FindFirstChild('SchedulingProfiler')).markStateUpdateScheduled
