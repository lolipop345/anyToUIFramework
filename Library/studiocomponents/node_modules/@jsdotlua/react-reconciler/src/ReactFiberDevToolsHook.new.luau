...
local enableProfilerTimer =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags.enableProfilerTimer
...
local DidCapture = require(script.Parent:FindFirstChild('ReactFiberFlags')).DidCapture
