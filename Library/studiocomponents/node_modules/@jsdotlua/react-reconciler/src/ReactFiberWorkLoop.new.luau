...
local console = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).console
local LuauPolyfill = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('luau-polyfill'))
...
local ReactTypes = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
type Thenable<T> = ReactTypes.Thenable<T>
type Wakeable = ReactTypes.Wakeable

local ReactInternalTypes = require(script.Parent:FindFirstChild('ReactInternalTypes'))
type Fiber = ReactInternalTypes.Fiber
type FiberRoot = ReactInternalTypes.FiberRoot
type ReactPriorityLevel = ReactInternalTypes.ReactPriorityLevel
local ReactFiberLane = require(script.Parent:FindFirstChild('ReactFiberLane'))
type Lanes = ReactFiberLane.Lanes
type Lane = ReactFiberLane.Lane
-- The scheduler is imported here *only* to detect whether it's been mocked
local Scheduler = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('scheduler'))-- ROBLOX deviation: we import from top-level Scheduler exports to avoid direct file access


type Interaction = Scheduler.Interaction

local ReactFiberSuspenseComponent = require(script.Parent:FindFirstChild('ReactFiberSuspenseComponent.new'))
type SuspenseState = ReactFiberSuspenseComponent.SuspenseState
local ReactFiberStack = require(script.Parent:FindFirstChild('ReactFiberStack.new'))
type StackCursor<T> = ReactFiberStack.StackCursor<T>

local ReactFeatureFlags = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactFeatureFlags
...
local ReactShared = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))-- ROBLOX deviation: we pull in Dispatcher type because we need it for our lazy loading deviations to typecheck

type Dispatcher = ReactShared.Dispatcher
local describeError = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).describeError
local ReactSharedInternals = ReactShared.ReactSharedInternals
local invariant = ReactShared.invariant

local SchedulerWithReactIntegration = require(script.Parent:FindFirstChild('SchedulerWithReactIntegration.new'))
...
local DebugTracing = require(script.Parent:FindFirstChild('DebugTracing'))-- local {
...
local SchedulingProfiler = require(script.Parent:FindFirstChild('SchedulingProfiler'))

local SchedulerTracing = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('scheduler')).tracing
local __interactionsRef, __subscriberRef =
	SchedulerTracing.__interactionsRef, SchedulerTracing.__subscriberRef

local ReactFiberHostConfig = require(script.Parent:FindFirstChild('ReactFiberHostConfig'))-- deviation: Use properties directly instead of localizing to avoid 200 limit
...
local ReactFiber = require(script.Parent:FindFirstChild('ReactFiber.new'))-- deviation: Use properties directly instead of localizing to avoid 200 limit
...
local ReactTypeOfMode = require(script.Parent:FindFirstChild('ReactTypeOfMode'))-- deviation: Use properties directly instead of localizing to avoid 200 limit
...
local ReactWorkTags = require(script.Parent:FindFirstChild('ReactWorkTags'))-- deviation: Use properties directly instead of localizing to avoid 200 limit
...
local LegacyRoot = require(script.Parent:FindFirstChild('ReactRootTags')).LegacyRoot
local ReactFiberFlags = require(script.Parent:FindFirstChild('ReactFiberFlags'))
...
local ReactFiberTransition = require(script.Parent:FindFirstChild('ReactFiberTransition'))-- deviation: Use properties directly instead of localizing to avoid 200 limit
...
local ReactFiberUnwindWork = require(script.Parent:FindFirstChild('ReactFiberUnwindWork.new')):: any
local unwindWork = ReactFiberUnwindWork.unwindWork
local unwindInterruptedWork = ReactFiberUnwindWork.unwindInterruptedWork
local ReactFiberThrow = require(script.Parent:FindFirstChild('ReactFiberThrow.new')):: any
...
local ReactFiberCommitWork = require(script.Parent:FindFirstChild('ReactFiberCommitWork.new'))
...
local Promise = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('promise'))

local enqueueUpdate = require(script.Parent:FindFirstChild('ReactUpdateQueue.new')).enqueueUpdate

local resetContextDependencies =
	require(script.Parent:FindFirstChild('ReactFiberNewContext.new')).resetContextDependencies
	...
	function(current: Fiber | nil, workInProgress: Fiber, renderLanes: Lanes): Fiber | nil
		if not lazyInitRefs.originalBeginWorkRef then
			lazyInitRefs.originalBeginWorkRef =
				require(script.Parent:FindFirstChild('ReactFiberBeginWork.new')).beginWork
		end
	...
	function(current: Fiber | nil, workInProgress: Fiber, renderLanes: Lanes): Fiber | nil
		if not lazyInitRefs.completeWorkRef then
			lazyInitRefs.completeWorkRef =
				require(script.Parent:FindFirstChild('ReactFiberCompleteWork.new')).completeWork
		end
...
local function initReactFiberHooks()
	ReactFiberHooks = require(script.Parent:FindFirstChild('ReactFiberHooks.new'))	
...
local createCapturedValue = require(script.Parent:FindFirstChild('ReactCapturedValue')).createCapturedValue
...
local ReactProfilerTimer = require(script.Parent:FindFirstChild('ReactProfilerTimer.new'))
-- DEV stuff

local getComponentName = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).getComponentName
local ReactStrictModeWarnings = require(script.Parent:FindFirstChild('ReactStrictModeWarnings.new'))
local ReactCurrentFiber = require(script.Parent:FindFirstChild('ReactCurrentFiber'))-- deviation: these two properties would be captured as values instead of bound
...
local ReactErrorUtils = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactErrorUtils
...
local onCommitRootDevTools = require(script.Parent:FindFirstChild('ReactFiberDevToolsHook.new')).onCommitRoot
local onCommitRootTestSelector = require(script.Parent:FindFirstChild('ReactTestSelectors')).onCommitRoot

-- Used by `act`
local enqueueTask = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).enqueueTask
local doesFiberContain = require(script.Parent:FindFirstChild('ReactFiberTreeReflection')).doesFiberContain
...
local ReactFiberWorkInProgress = require(script.Parent:FindFirstChild('ReactFiberWorkInProgress'))
