...
local inspect = require(script.Parent:FindFirstChild('inspect'))
local isArray = require(script.Parent:FindFirstChild('Array'):FindFirstChild('isArray'))
local arrayForEach = require(script.Parent:FindFirstChild('Array'):FindFirstChild('forEach'))
local arrayFromString = require(script.Parent:FindFirstChild('Array'):FindFirstChild('from'):FindFirstChild('fromString'))

local types = require(script.Parent.Parent.Parent.Parent:FindFirstChild('luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('es7-types'))
