...
local arrayForEach = require(script.Parent.Parent:FindFirstChild('Array'):FindFirstChild('forEach'))
local arrayMap = require(script.Parent.Parent:FindFirstChild('Array'):FindFirstChild('map'))
local isArray = require(script.Parent.Parent:FindFirstChild('Array'):FindFirstChild('isArray'))
