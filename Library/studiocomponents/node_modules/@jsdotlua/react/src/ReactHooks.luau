...
local ReactTypes = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))-- ROBLOX TODO: we only pull in Dispatcher here for the typecheck, remove once Luau narrowing improves
...
local ReactFiberHostConfig = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
...
local ReactCurrentDispatcher =
	require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).ReactSharedInternals.ReactCurrentDispatcher
