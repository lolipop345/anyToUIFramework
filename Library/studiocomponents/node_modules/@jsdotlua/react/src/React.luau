...
local createMutableSource = require(script.Parent:FindFirstChild('ReactMutableSource'))
...
local ReactBaseClasses = require(script.Parent:FindFirstChild('ReactBaseClasses'))
local ReactChildren = require(script.Parent:FindFirstChild('ReactChildren'))
local ReactElementValidator = require(script.Parent:FindFirstChild('ReactElementValidator'))
local ReactElement = require(script.Parent:FindFirstChild('ReactElement'))
local ReactCreateRef = require(script.Parent:FindFirstChild('ReactCreateRef'))
local ReactForwardRef = require(script.Parent:FindFirstChild('ReactForwardRef'))
local ReactHooks = require(script.Parent:FindFirstChild('ReactHooks'))
local ReactMemo = require(script.Parent:FindFirstChild('ReactMemo'))
local ReactContext = require(script.Parent:FindFirstChild('ReactContext'))
local ReactLazy = require(script.Parent:FindFirstChild('ReactLazy'))
type LazyComponent<T, P> = ReactLazy.LazyComponent<T, P>

-- ROBLOX DEVIATION: Bindings
local ReactBinding = require(script.Parent:FindFirstChild('ReactBinding.roblox'))-- ROBLOX DEVIATION: Re-export `None` marker

local ReactNone = require(script.Parent:FindFirstChild('None.roblox'))

local SharedModule = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared'))
...
return {
	...
	Event = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Event,
	Change = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Change,
	Tag = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).Tag,
	...
	unstable_parseReactError = require(script.Parent.Parent.Parent.Parent:FindFirstChild('.luau-aliases'):FindFirstChild('@jsdotlua'):FindFirstChild('shared')).parseReactError,
}
