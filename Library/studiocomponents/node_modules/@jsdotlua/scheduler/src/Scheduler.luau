...
return function(hostConfig)
	...
	local SchedulerFeatureFlags = require(script.Parent:FindFirstChild('SchedulerFeatureFlags'))	
local enableSchedulerDebugging = SchedulerFeatureFlags.enableSchedulerDebugging
	...
	local SchedulerHostConfig = hostConfig or require(script.Parent:FindFirstChild('SchedulerHostConfig'))	
local requestHostCallback = SchedulerHostConfig.requestHostCallback
	...
	-- TODO: Use symbols?
	local SchedulerPriorities = require(script.Parent:FindFirstChild('SchedulerPriorities'))	
local ImmediatePriority = SchedulerPriorities.ImmediatePriority
	...
	local SchedulerProfiling = require(script.Parent:FindFirstChild('SchedulerProfiling'))	
